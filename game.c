 ...
 * СХЕМА УПРАВЛЕНИЯ:
 *
 * ESC  — всегда: во время игры → меню, в рекордах → меню,
 *                в меню → выход из программы, на WIN/LOSE → меню
 * R    — только во время игры и на экране WIN/LOSE → рестарт
 * L    — в меню, во время игры, на WIN/LOSE → таблица рекордов
 *        (на экране рекордов L ничего не делает — уже там)
 */
